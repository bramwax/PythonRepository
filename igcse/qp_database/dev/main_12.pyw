...
class Application:
    ...
    def ins_widgets(self): # ------------------------------------------------------------------------------------------- >> populate insert tab (widgets) <<
        ...
        ttk.Label(self.ins_tab, text = 'ADD PAPER').place(x = 635, y = 16, anchor = 'nw')
        ...
        ttk.Label(self.ins_tab, text = 'Year:').place(x = 704, y = 192, anchor = 'ne')
        ...
        self.paper_bt.place(x = 825, y = 190, anchor = 'nw')
    ...
    def insert_question(self, question, mark, note, paper, objective):
