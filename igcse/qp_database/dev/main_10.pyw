...
class Application:
    ...
    def __init__(self, root):
        ...
        # ------------------------- >> initiate creation of gui elements & run application  <<
        self.set_styles()
        self.create_tabs()
    ...
    def qry_widgets(self):

        # ----- >> units label & combobox  <<
        ttk.Label(self.qry_tab,
                  text = 'Select a unit...').place(x = 16, y = 16, anchor = 'nw')
        ...
        tk.Label(self.qry_tab,
                 text = 'Select a subunit...').place(x = 16, y = 82, anchor = 'nw')
        ...
        tk.Label(self.qry_tab,
                 text = 'Select an objective').place(x = 16, y = 148, anchor = 'nw')
        ...
        tk.Label(self.qry_tab,
                 text = 'Questions by objective').place(x = 16, y = 242, anchor = 'nw')
    ...
    def ins_widgets(self):

        # ----- >> papers label & separator  <<
        ttk.Label(self.ins_tab,
                  text = 'Add a paper...').place(x = 635, y = 16, anchor = 'nw')
        ...
        ttk.Label(self.ins_tab,
                  text = 'Year:').place(x = 690, y = 192, anchor = 'ne')
        ...
        ttk.Label(self.ins_tab,
                  text = 'Session:').place(x = 704, y = 239, anchor = 'ne')
        ...
        ttk.Label(self.ins_tab,
                  text = 'Paper:').place(x = 704, y = 282, anchor = 'ne')
    ...
    def set_objective(self, event):
        ...
        self.questions_tv.delete(*self.questions_tv.get_children())
        questions = self.get_questions(self.conn)
    ...
    def check_paper(self, year, session, paper):
        # ------------------------------ >> fetch data <<
    ...
    def insert_paper(self):
        ...
        if year != '' and session != '' and paper != '':
            duplicate = self.check_paper(year, session, paper)
