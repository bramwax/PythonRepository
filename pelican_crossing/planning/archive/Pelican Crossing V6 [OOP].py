...
class splashCanvas:
    ...
    def onButtonOver(self, event):
        if mainWindow.getStatus() == "waiting":
    ...
    def onButtonClick(self, event):
        ...
        self.splashCanvas.after(2495, lambda: mainWindow.setStatus("running"))
...
root = Tk()
mainWindow = applicationWindow(root, "Pelican Crossing Simulator")
