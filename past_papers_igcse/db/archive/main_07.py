...
class Application:
    ...
    def create_widgets(self):
        ...
        self.questions_tv = ttk.Treeview(self.root,
                                         ...
                                         show='headings',
                                         height=20)
        self.questions_tv.heading('#1', text='Year')
        self.questions_tv.column('#1', minwidth=0, width=50)
        self.questions_tv.heading('#2', text='Session')
        self.questions_tv.column('#2', minwidth=0, width=70)
        self.questions_tv.heading('#3', text='Paper')
        self.questions_tv.column('#3', minwidth=0, width=50)
        self.questions_tv.heading('#4', text='Question')
        self.questions_tv.column('#4', minwidth=0, width=80)
        self.questions_tv.heading('#5', text='Mark')
        self.questions_tv.column('#5', minwidth=0, width=50)
        self.questions_tv.heading('#6', text='Note')
        self.questions_tv.column('#6', minwidth=0, width=600)
        self.questions_tv.pack(side=tk.TOP, anchor=tk.NW, padx=20, pady=10)
